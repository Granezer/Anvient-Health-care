...
const how_ready = document.getElementById("how_ready");
...
async function getForm(e) {
  ...
  console.log(appliedLocation, appliedProfession);
}

const apply = async () => {
  const payload = {
    appliedFor: {
      profession: appliedProfession.value,
      location: appliedLocation.value,
    },
...
applyForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    alert("Thanks for applying, your application has been sent and attended to.");
  } catch (error) {
